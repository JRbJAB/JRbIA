 ...
 * JRbIA Backup config.
 * File: 01_Config.gs
 * v0.4R2: rebased on live trace 1b7d2a35; no monofile duplicates.
 */

const JRBIA_CFG = {
  VERSION: 'v0.4.1-JRBIA-COCKPIT-FROM-LIVE-1B7D2A35',
  LOG_SHEET: '🧾 Logs AS',
  EXPORT_SHEET: '📤 Exports AS',
  JOURNAL_SHEET: '🧾 Journal AS',
  DELIVERABLES_SHEET: '📦 Livrables & Versions',
